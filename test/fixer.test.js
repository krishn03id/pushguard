...
try {
  ...
  assert(!app.includes('sk-1234567890abcdefghijklmnopqrstuvwxyzABCDEF'), 'should remove raw secret from code'); // pushguard: allow test fixture
  assert(fs.readFileSync('.env', 'utf8').includes('OPENAI_API_KEY=sk-1234567890abcdefghijklmnopqrstuvwxyzABCDEF'), 'should write .env'); // pushguard: allow test fixture
