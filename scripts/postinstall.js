...
// One-time auto setup after: npm install -g pushguard
// Creates ~/.pushguard/hooks/pre-push and sets Git global core.hooksPath.
// To skip: PUSHGUARD_SKIP_POSTINSTALL=1 npm install -g pushguard
...
function main() {
  ...
  try {
    ...
    console.log('   Run this manually later: pushguard install --global --paranoid');
    console.log('');
